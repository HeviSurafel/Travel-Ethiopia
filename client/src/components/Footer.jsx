...
import logo  from '../../assets/pexels-karolina-grabowska-5632381.jpg'
import {FaFacebookF,FaDribbble,FaLinkedinIn,FaInstagram,FaBehance} from 'react-icons/fa'

const Footer = () => {
  return (
    <div className="w-full h-min bg-white relative bottom-0 left-0  my-4">
        <div className='md:max-w-[1480px] m-auto grid md:grid-cols-5 max-[780px]:grid-cols-2  gap-8 max-w-[600px]  px-4 md:px-0'>
            
            <div className='col-span-2'>
                <img src={logo} className="h-[25px]" />
                <h3 className='text-2xl font-bold mt-10'>Contact Us</h3>
                <h3 className='py-2 text-[#6D737A]'>Call : +251964945647</h3>
                <h3 className='py-2 text-[#455363]'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Harum, voluptate. <br></br>Lorem ipsum dolor sit.</h3>
                <h3 className='py-2 text-[#363A3D]'>Email: surafelwondu5647@mail.com</h3>
